...
var SnowService = function () {
  function SnowService(state) {
    ...
    for (var i = 0; i < MAX_FLAKES * window.devicePixelRatio; i++) {
      ...
      this.updateFlake(i, Math.random() * this.game.width, Math.random() * this.game.height);
    }
    this.angle = 0;
  }
...
var UIService = function () {
  function UIService(_ref) {
    ...
    this.timer = this.game.time.events.loop(1000, this.endGame, this);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create(args) {
      ...
      image.scale.set(scale > scaleY ? scaleY : scale);
      this.game.input.onDown.add(function () {
        var branch = getParameterByName('branch') || 'FERNNNZyGI';
